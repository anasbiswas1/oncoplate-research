...
| `29_foundation_dinov2.ipynb` | 29 · DINOv2 frozen heads: baseline, backbone comparison, calibration and selective prediction | Anchor-backbone replication of notebooks 27 and 28 with paired participant-group intervals. Test records are not read. |
